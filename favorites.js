    ...
    if (favouritesList.length === 0) {
        ...
        favouritesList.forEach(movie => {
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-center"> <!-- Flex container to align buttons -->
                    <button class="btn btn-danger btn-sm remove-button" data-imdbid="${movie.imdbID}">Remove</button>
                    <a href="movie.html?id=${movie.imdbID}" class="btn btn-warning btn-secondary btn-sm more-button">More</a>
                </div>
            </div>
        `;
